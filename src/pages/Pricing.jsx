...
const pricingData = [
  {
    image: "https://namratauniversal.com/img/static.jpeg",
  ...
  {
    image: "https://namratauniversal.com/img/dynamic.jpeg",
    ...
    features: [
      ...
      "Free 1 yr Domain",
      "5 GB integrated",
      "Free Google Font Hosting",
      "Easy Admin Panel Managing Website",
      "Social Networking",
      "3 Mail ID",
      "Icons",
      "Photo Gallery",
  ...
  {
    image: "https://namratauniversal.com/img/ecommerce.jpeg",
    title: "E-commerce Website",
    features: [
      "Multiple Admin Panel for Multiple Users",
      "Admin Panel for Seller",
      "Easy Admin Panel for Managing Products",
      "Mobile Responsive",
      "Unlimited Product",
      "20 GB Hosting",
      "Categories",
    ...
    <div className="min-h-screen bg-gray-50 py-16 px-6 pt-28">
      <div className="max-w-6xl mx-auto text-center mb-12 px-4">
        ...
        <p className="text-gray-600 text-lg">
          For demo please contact to Namrata Universal.
        </p>
      </div>

      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        {pricingData.map(({ image, title, features }, idx) => (
          <div
            key={idx}
          ...
          >
            ...
            <div className="p-6 flex flex-col flex-grow">
              ...
              <ul className="flex-grow mb-6 space-y-2 text-gray-700 text-sm">
